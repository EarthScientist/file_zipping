			...
			for year in year_groups[val]:
				for mon in months:
					if v == "tas":
						...
						zf.write(os.path.join("/big_storage/malindgren/AIEM/ALFRESCO_AIEM_CLIP/ALFRESCO_Master_Dataset/ALFRESCO_Model_Input_Datasets/AK_CAN_Inputs/Climate",model,"sresa1b","tas","tas_mean_C_iem_ar4_"+model+"_sresa1b_"+mon+"_"+str(year)+".tif"), arcname="tas_mean_C_iem_ar4_"+model+"_sresa1b_"+mon+"_"+str(year)+".tif",compress_type=compression)
					else:
